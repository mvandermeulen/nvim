...
> Reference guide for all project development. For detailed
task planning, see [TASK_PLAN_GUIDE.md](.claude/docs/guides/TASK_PLAN_GUIDE.md)
...
- **Type Hints**: Use the typing library for clear type annotations to improve code understanding and tooling
  ...
  def process_document(doc_id: str, options: dict[str, str] = None) -> dict[str, Any]:
