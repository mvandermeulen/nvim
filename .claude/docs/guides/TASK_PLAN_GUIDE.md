...
- Module-specific tasks: `.claude/docs/plans/[module_name]/tasks/`
- Project-level tasks: `project_tasks.md` in `.claude/docs/plans/`
- Integration tasks: `.claude/docs/plans/[module_name]/tasks/integration_task.md`
