...
- **Primary Location**: `{{HOME_TOOL_DIR}}/session/handover/handover-{{TIMESTAMP}}.md`

The path to the handover file MUST also be saved to:
- **File Pointer Location**: `{{HOME_TOOL_DIR}}/session/last-handover.md`
