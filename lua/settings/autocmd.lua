...
vim.api.nvim_create_autocmd("FileType", {
    ...
    callback = function()
      ...
      vim.keymap.set("n", "<M-i>c", function() require("helpers.user.utils").md_block() end, { noremap = true, silent = true, desc = 'Make word Markdown Link' })
      ...
      vim.keymap.set("n", "<C-a>", function() require("helpers.user.utils").increase_header() end, { noremap = true, silent = true, desc = 'Increase Markdown Header' })
      vim.keymap.set("n", "<C-x>", function() require("helpers.user.utils").decrease_header() end, { noremap = true, silent = true, desc = 'Decrease Markdown Header' })
    end
})
