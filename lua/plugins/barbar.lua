...
vim.g.bufferline = {
  ...
  icons = true,                                -- Enable/disable icons. If set to 'numbers', will show buffer index in the tabline. If set to 'both', will show buffer index and icons in the tabline.
  ...
  -- If true, new buffers will be inserted at the start/end of the list. Default is to insert after current buffer.
  insert_at_end = false,
