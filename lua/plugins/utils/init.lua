...
local M = {
  ...
  {-- folke/which-key.nvim
    ...
    opts = {
      ...
      spec = {
        ...
        { "<leader>ec", group = "Commands" },
        { "<leader>ect", group = "Tabs" },
        { "<leader>eC", group = "Copy" },
        -- { "<leader>ef", group = "Flash" },
        { "<leader>eg", group = "Glance" },
        { "<leader>eL", group = "Lazy" },
        { "<leader>en", group = "Noice" },
        { "<leader>er", group = "Find & Replace" },
        { "<leader>es", group = "Settings" },
        { "<leader>eS", group = "Snacks" },
        { "<leader>eu", group = "User" },
        { "<leader>euF", group = "Line Fill" },
        { "<leader>f", group = "Find" },
  ...
  {-- folke/snacks.nvim
    ...
    keys = {
      ...
      { "<C-S-R>", function() Snacks.picker.recent() end, desc = "Recent" },
      { "<C-S-M>", function() Snacks.picker.projects() end, desc = "Projects" },
      { "<C-.>", function() Snacks.explorer() end, desc = "File Explorer" },
      -- Replaced 2025-07-15 with my own helper function
      ...
      { "<leader>gB", function() Snacks.gitbrowse() end, desc = "Git Browse (Safari)", mode = { "n", "v" } },
      ...
      { "<C-S-N>",      function() Snacks.terminal() end, desc = "Toggle Terminal" },
