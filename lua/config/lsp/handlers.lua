...
local function lsp_keymaps(bufnr)
  ...
  bufnnoremap("gd", "<cmd>lua vim.lsp.buf.definition()<CR>", 'go-to-definition')
  bufnnoremap("gD", "<cmd>lua vim.lsp.buf.declaration()<CR>", 'go-to-declaration')
  bufnnoremap("gl", "<cmd>lua vim.diagnostic.open_float()<CR>", 'show-diagnostics-float')
  bufnnoremap("gm", "<cmd>lua vim.lsp.buf.implementation()<CR>", 'go-to-implementation')
  bufnnoremap("gy", "<cmd>lua vim.lsp.buf.type_definition()<CR>", 'go-to-type-definition')
  bufnnoremap("gI", "<cmd>lua vim.lsp.buf.incoming_calls()<CR>", 'go-to-incoming-calls')
  bufnnoremap("<localleader>gR", "<cmd>lua vim.lsp.buf.rename()<CR>", 'lsp-rename')
  bufnnoremap("<localleader>gs", "<cmd>lua vim.lsp.buf.signature_help()<CR>", 'show-signature-help')
  ...
  bufnnoremap("K", "<cmd>lua vim.lsp.buf.hover()<CR>", 'show-hover')
  bufnnoremap("<M-k>", "<cmd>lua vim.lsp.buf.signature_help()<CR>", 'show-signature')
  bufnnoremap("<localleader>ca", "<cmd>lua vim.lsp.buf.code_action()<CR>", 'lsp-code-action')
  bufnnoremap("<leader>df", "<cmd>lua vim.diagnostic.open_float()<CR>", 'show-diagnostics-float')
