...
M.setup = function()
  ...
  vim.api.nvim_set_keymap("n", "<M-b>n", ":LTOpenNotebook<cr>", opts)
  vim.api.nvim_set_keymap("n", "<M-b>o", ":LTOpenToNotebook<cr>", opts)
  vim.api.nvim_set_keymap("n", "<M-b>oo", ":LTPopOutNotebook<cr>", opts)
  vim.api.nvim_set_keymap("n", "<M-b>l", ":LTListNotebooks<cr>", opts)
  vim.api.nvim_set_keymap("n", "<M-b>c", ":LTCreateBookmark<cr>", opts)
  vim.api.nvim_set_keymap("n", "<M-B>h", ":LTHideBookmarks<cr>", opts)
